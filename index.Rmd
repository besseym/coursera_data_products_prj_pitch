...
p <- p + labs(x = "Father's Height", y = "Mother's Height")
...
The Child Height Prediction Product will continue to become a more useful tool. Additional family data will be gathered and added to the model. This additional data will make the model's prediction algorithm more accurate which will ultimately make the tool more desirable for curious couples.
